...
#department error corrected
    ...
    def create_user(self,user):
        ...
        db_user = ORMUser.objects.create(firstname=user.firstname,lastname=user.lastname,college_name=user.college_name,email=user.email,role=role_,dept_name=dept,username=user.username,password=user.password,phone=user.phone)
