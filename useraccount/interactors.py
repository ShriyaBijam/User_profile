...
#can add user_validator as second argument of this func
    ...
    def set_params(self,firstname,lastname,college_name,email,role,dept_name,username,password,phone):
        #self.id = id
        self.firstname = firstname
        self.lastname = lastname
        self.college_name = college_name
    ...
    def execute(self):
        ...
        user = User(firstname=self.firstname,lastname=self.lastname,college_name=self.college_name,email=self.email,role=self.role,dept_name=self.dept_name,username=self.username,password=self.password,about_me=None,phone=self.phone,skill=None)
