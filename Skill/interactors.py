...
class CreateNewSkillInteractor(object):
    ...
    def set_params(self,skill_name):
    ...
    def execute(self):
        ...
        return self.skill_repo.create_new_skill(skill)
...
class GetAllSkillByUserInteractor(object):
    ...
    def set_params(self, ormuser):
        self.ormuser = ormuser
        return self

    def execute(self):
        return self.skill_repo.get_all_skill_by_user(ormser = self.ormuser)
